...
INSERT INTO `sys_user` (`id`, `user_name`, `mobile`, `user_nickname`, `birthday`, `user_password`, `user_salt`, `user_status`, `user_email`, `sex`, `avatar`, `remark`, `is_admin`, `address`, `describe`, `last_login_ip`, `last_login_time`, `created_at`, `updated_at`, `deleted_at`) VALUES
                                                                                                                                                                                                                                                                                             (1, 'admin', '13578342363', '超级管理员', 0, 'c567ae329f9929b518759d3bea13f492', 'f9aZTAa8yz', 1, 'yxh669@qq.com', 1, 'https://yxh-1301841944.cos.ap-chongqing.myqcloud.com/gfast/2021-07-19/ccwpeuqz1i2s769hua.jpeg', '', 1, 'asdasfdsaf大发放打发士大夫发按时', '描述信息', '::1', '2022-09-14 11:17:55', '2021-06-22 17:58:00', '2022-09-14 11:17:55', NULL),
...
--
ALTER TABLE `sys_login_log`
    MODIFY `info_id` bigint NOT NULL AUTO_INCREMENT COMMENT '访问ID', AUTO_INCREMENT=903;
