...
--
-- 插入之前先把表清空（truncate） `casbin_rule`
--
...
--
-- 插入之前先把表清空（truncate） `sys_auth_rule`
--
...
--
-- 插入之前先把表清空（truncate） `sys_dict_data`
--
...
--
-- 插入之前先把表清空（truncate） `sys_dict_type`
--
...
--
-- 插入之前先把表清空（truncate） `sys_login_log`
--
...
--
-- 插入之前先把表清空（truncate） `sys_oper_log`
--
...
(1, 'admin', '13578342363', '超级管理员', 0, 'c567ae329f9929b518759d3bea13f492', 'f9aZTAa8yz', 1, 'yxh669@qq.com', 1, 'https://yxh-1301841944.cos.ap-chongqing.myqcloud.com/gfast/2021-07-19/ccwpeuqz1i2s769hua.jpeg', '', 1, 'asdasfdsaf大发放打发士大夫发按时', '描述信息', '::1', '2022-09-13 08:48:17', '2021-06-22 17:58:00', '2022-09-13 08:48:17', NULL),
...
CREATE TABLE `verify_card_session` (
  ...
  `device_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设备ID',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '修改时间',
  `deleted_at` datetime DEFAULT NULL COMMENT '删除时间'
...
--
ALTER TABLE `sys_dict_data`
  MODIFY `dict_code` bigint NOT NULL AUTO_INCREMENT COMMENT '字典编码', AUTO_INCREMENT=105;

--
-- 使用表AUTO_INCREMENT `sys_dict_type`
--
ALTER TABLE `sys_dict_type`
  MODIFY `dict_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '字典主键', AUTO_INCREMENT=51;

--
-- 使用表AUTO_INCREMENT `sys_login_log`
--
ALTER TABLE `sys_login_log`
  MODIFY `info_id` bigint NOT NULL AUTO_INCREMENT COMMENT '访问ID', AUTO_INCREMENT=899;
