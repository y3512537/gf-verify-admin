...
(1, 'admin', '13578342363', '超级管理员', 0, 'c567ae329f9929b518759d3bea13f492', 'f9aZTAa8yz', 1, 'yxh669@qq.com', 1, 'https://yxh-1301841944.cos.ap-chongqing.myqcloud.com/gfast/2021-07-19/ccwpeuqz1i2s769hua.jpeg', '', 1, 'asdasfdsaf大发放打发士大夫发按时', '描述信息', '::1', '2022-09-20 11:54:05', '2021-06-22 17:58:00', '2022-09-20 11:54:05', NULL),
...
CREATE TABLE `verify_card_session` (
  ...
  `status` int DEFAULT '0' COMMENT '设备状态 1 在线 0 离线',
